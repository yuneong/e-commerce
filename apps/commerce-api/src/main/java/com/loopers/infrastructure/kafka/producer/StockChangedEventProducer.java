...
public class StockChangedEventProducer {
    ...
    // fallback
    public void StockChangedFallback(Long productId, Object event, Throwable ex) {
        log.error("Failed to send stock changed event after retries, productId={}", productId, ex);
    }
